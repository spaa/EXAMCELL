...
<body>
  ...
  <form class="w3-mobile w3-margin" action="../html/dashboard_general.html" autocomplete novalidate>
      ...
      <div class="w3-container w3-row-padding">
        ...
        <div class="w3-half w3-row">
          <span class="w3-quarter w3-large label">SEMESTER:</span>
            <input type="text" class="w3-threequarter w3-input" name="semester" <?php echo"value='$current_year_ch'";?>>
        </div>
      </div>
      <div class="w3-container w3-center w3-padding-large" onclick="hide_show('','Container1')">
        <input type="radio" class="w3-radio" name="form_type" value="Regular"><label>REGULAR</label>
        <input type="radio" class="w3-radio" name="form_type" value="ATKT"><label>ATKT</label>
      </div>
    </div>
