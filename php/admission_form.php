...
?>
<?php include'admission_form.inc.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<?php if(isset($_POST['regular_exam_form'])):?>
<!-- Create action form -->
      ...
      <div class="w3-container w3-row-padding">
        ...
        <div class="w3-half w3-row">
          <span class="w3-quarter w3-large label">SEMESTER:</span>
            <input type="text" class="w3-threequarter w3-input" name="semester" disabled <?php echo"value='$current_sem'";?>>
        </div>
      </div>
      <div class="w3-container w3-center w3-padding-large" onclick="hide_show('','Container1')">
        <input type="radio" class="w3-radio" name="form_type" value="Regular" disabled checked><label>REGULAR</label>
        <input type="radio" class="w3-radio" name="form_type" value="ATKT" disabled><label>ATKT</label>
      </div>
    </div>
