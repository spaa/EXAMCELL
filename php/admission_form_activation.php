...
if($month>=1 && $month<=5){
    ...
    $json_file = "../files/notifications_for_student/notifications_by_exam_cell_for_filling_admission_form/activate_admission_form_link.json";    
    $notification[] = array(
        'year' => date("Y"),
    ...
    if(file_put_contents($json_file,json_encode($notification))){
        $_SESSION['message'] = "SUCCESS NOW STUDENTS CAN FILL ADMISSION FORM";
...
<div class="w3-margin w3-panel w3-display-container w3-pale-blue w3-bottombar w3-border-yellow w3-border">
    ...
    <p><strong>NOTE...!</strong> ACTIVATE ADMISSION FORM FOR YEAR FE, SE, TE, BE</p>
</div>
...
<div class="w3-container">
    ...
    <div class="w3-container w3-white w3-card-4 w3-center" id="messageNotification">
        <p>
            <form action="admission_form_activation.php" method="POST">
                <p id="message"> ADMISSION FORM IS ACTIVATED </p>
